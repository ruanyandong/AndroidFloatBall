package com.example.myapplication.floatball.widget.textcounter;
...
import com.qukandian.video.qkdbase.floatball.widget.textcounter.formatters.CommaSeparatedDecimalFormatter;
import com.qukandian.video.qkdbase.floatball.widget.textcounter.formatters.DecimalFormatter;
import com.qukandian.video.qkdbase.floatball.widget.textcounter.formatters.IntegerFormatter;
import com.qukandian.video.qkdbase.floatball.widget.textcounter.formatters.NoFormatter;
...
public class CounterView extends AppCompatTextView {
    ...
    public void start(int delay) {
        initCountRunnable();
        postDelayed(counter, delay);
    }

    private void initCountRunnable() {
        if (counter != null) {
            removeCallbacks(counter);
        }
