 ...
 */
package com.example.floatballv2.rom;

import android.os.Build;
import android.text.TextUtils;
import android.util.Log;

import com.example.floatballv2.utils.DeviceUtil;
...
public class RomUtils {
    ...
    public volatile static String sFloatBlackList;
    ...
    public static String getSystemProperty(String propName) {
        if (!TextUtils.isEmpty(sFloatBlackList)) {
            String phoneMode = DeviceUtil.getPhoneMode();
            if (!TextUtils.isEmpty(phoneMode) && sFloatBlackList.contains(phoneMode)) {
                return null;
            }
        }
        String line;
