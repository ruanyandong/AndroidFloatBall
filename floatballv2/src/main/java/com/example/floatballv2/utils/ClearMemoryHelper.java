...
import com.example.floatballv2.BuildConfig;
...
//                            ppProcessInfo.importance
//                            + " list:" + Arrays.toString(pkgList));
                } else {
                    //Log.d(StartFloatBallService.TAG, "processName:" + appProcessInfo.processName + " importance:" + appProcessInfo.importa
                }
            }
        }
